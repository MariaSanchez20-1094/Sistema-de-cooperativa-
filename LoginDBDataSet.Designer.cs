...
namespace SisCoperativa.LoginDBDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([Id] = @Original_Id) AND ((@IsNull_NombreUsuario = 1 AND [NombreUsuario] IS NULL) OR ([NombreUsuario] = @Original_NombreUsuario)) AND ((@IsNull_Contraseña = 1 AND [Contraseña] IS NULL) OR ([Contraseña] = @Original_Contraseña)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([NombreUsuario], [Contraseña]) VALUES (@NombreUsuar" +
                "io, @Contraseña);\r\nSELECT Id, NombreUsuario, Contraseña FROM Usuarios WHERE (Id " +
                "= SCOPE_IDENTITY())";
...
SELECT Id, NombreUsuario, Contraseña FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SisCoperativa.Properties.Settings.Default.LoginDBConnectionString;
        }
        ...
        public virtual int Fill(LoginDBDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual LoginDBDataSet.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet.UsuariosDataTable dataTable = new LoginDBDataSet.UsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet.UsuariosDataTable dataTable) {
